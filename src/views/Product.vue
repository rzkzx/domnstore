                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="product-thumbs">
                                    <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                        <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == defaultPhoto? 'active' : ''">
                                            <img src="img/mickey1.jpg" alt="" />
                                        </div>

                                        <div class="pt" @click="changeImage(thumbs[1])" :class="thumbs[1] == defaultPhoto? 'active' : ''">
                                            <img src="img/mickey2.jpg" alt="" />
                                        </div>

                                        <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == defaultPhoto? 'active' : ''">
                                            <img src="img/mickey3.jpg" alt="" />
                                        </div>

                                        <div class="pt" @click="changeImage(thumbs[3])" :class="thumbs[3] == defaultPhoto? 'active' : ''">
...
<script>
    import HeaderDomn from '@/components/HeaderDomn.vue';
    import FooterDomn from '@/components/FooterDomn.vue';
    import RelatedDomn from '@/components/RelatedDomn.vue';
